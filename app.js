...
(function(){
    ...
    // Crear una nueva clase que herede de esta clase
    Class.extend = function(prop) {
      var _super = this.prototype;
     
      // Cree una instancia de una clase base (pero solo cree la instancia, no ejecute el constructor init)
      initializing = true;
      var prototype = new this();
      initializing = false;
     
      // Copian las propiedades en el nuevo prototipo.
      for (var name in prop) {
        // Comprobar si estamos sobrescribiendo una funcion
      ...
      function Class() {
        // Todas las construcciones hechas en el init
      ...
      // Consructor que sea lo que esperamos
  ...
  var LEFT_KEY = 37;
  var RIGHT_KEY = 39; 
  var SHOOT_KEY = 32; // Espacio para disparar
  ...
  function initCanvas() {
    ...
    // Añadir escucha de eventos y resize
